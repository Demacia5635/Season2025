...
public class FieldTarget {
    ...
    public static Translation2d l2Left = new Translation2d(0.63, -0.14);
    public static Translation2d l2Right = new Translation2d(0.63, 0.22);
    ...
    public enum POSITION{
        ...
        public Pose2d getApproachPoint(Translation2d offset) {
    ...
    public Pose2d getReefAvoidPoint(){
    ...
    public Pose2d getApproachingPoint(){
        if(RobotContainer.chassis == null) return Pose2d.kZero;
    ...
    public Pose2d getFinishPoint() {
        return getElement(position.getId(), getCalcOffset());
    }

    public Pose2d getReefPole(){
    ...
    public static Pose2d getElement(int elementTag){
        return getElement(elementTag, Translation2d.kZero);
    }
    public static Pose2d getElement(int elementTag, Translation2d offset){
        Translation2d originToTag = O_TO_TAG[elementTag];
        offset = offset.rotateBy(TAG_ANGLE[elementTag]);
        return new Pose2d(originToTag.plus(offset), TAG_ANGLE[elementTag].plus(Rotation2d.kPi));
    }
