...
public class FieldTarget {
    ...
    public static Translation2d bottomAlgeaRightOffset = new Translation2d(0.53, 0.5);
    public static Translation2d bottomAlgeaLeftOffset = new Translation2d(0.53, -0.5);
