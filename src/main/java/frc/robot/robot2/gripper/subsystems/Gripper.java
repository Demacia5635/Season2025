...
package frc.robot.robot2.gripper.subsystems;
...
import static frc.robot.robot2.gripper.constants.GripperConstants.*;
...
public class Gripper extends SubsystemBase {
  ...
  private final Ultrasonic downSensor;
  ...
  public Gripper() {
    ...
    downSensor = new Ultrasonic(SensorConstants.DOWN_SENSOR_CHANNEL.getFirst(), SensorConstants.DOWN_SENSOR_CHANNEL.getSecond());
  ...
  public double getDownSensor() {
    return downSensor.getRangeMM() / 1000;
  }
