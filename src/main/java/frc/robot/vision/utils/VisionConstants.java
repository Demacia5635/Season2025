...
public class VisionConstants {
    ...
    public static final double[] CAM_PITHC = {18,33,33};
    public static final double[] CAM_YAW = {10,0,180};
    ...
    public static final String[] TABLE = {"limelight-bottom","limelight-front","limelight-note"};
