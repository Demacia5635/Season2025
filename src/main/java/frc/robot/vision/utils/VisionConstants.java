...
public class VisionConstants {
    ...
    public static final double[] CAM_HIGHT = {0.78,0.91,0.91,0.797};
    public static final double[] CAM_PITHC = {54,33.5,34,74.5};
    public static final double[] CAM_YAW = {0,0,180,191};
    ...
    public static final String[] TABLE = {"limelight-bottom","limelight-front","limelight-back", "l imelight-backup"};
