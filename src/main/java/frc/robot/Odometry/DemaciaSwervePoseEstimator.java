 ...
 *
 * <p>{@link DemaciaSwervePoseEstimator#update} should be called every robot loop.
 *
 * <p>{@link DemaciaSwervePoseEstimator#addVisionMeasurement} can be called as infrequently as you
 * want; if you never call it, then this class will behave as regular encoder odometry.
 */
public class DemaciaSwervePoseEstimator extends DemaciaPoseEstimator<SwerveModulePosition> {
  ...
  public Pose2d updateWithTime(
    ...
    return updateWithTime(
        currentTimeSeconds, gyroAngle, modulePositions);
  }
