...
public class DemaciaOdometry {
    ...
    public DemaciaOdometry(DemaciaKinematics kinematics, Rotation2d gyroAngle, SwerveModulePosition[] wheelPositions, Pose2d initPose){
    ...
    public void resetPosition(Rotation2d gyroAngle, SwerveModulePosition[] wheelPos, Pose2d poseToReset){
        curPose = poseToReset;
    ...
    public Pose2d calcEstimatedPose(Rotation2d gyroAngle, SwerveModulePosition[] currentWheelPositions){
    ...
    //calcs
    public Pose2d estimateWheels(Rotation2d gyroAngle, SwerveModulePosition[] currentWheelPositions){
        ...
        prevWheelPositions = currentWheelPositions;
        prevAngle = angle;
