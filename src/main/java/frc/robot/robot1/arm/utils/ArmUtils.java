...
import static frc.robot.robot1.arm.utils.ArmConstants.*;
/** Add your docs here. */
public class ArmUtils {
    public static ArmState calcAngles(double dist, double hight){
        ...
        double jointA = 90 - angleToPoint - Math.toDegrees(Math.acos(((ARM1*ARM1) + (arm3*arm3) - (ARM2*ARM2))/(2*ARM1*arm3)));
        double jointB = 180 - Math.toDegrees(Math.acos(((ARM1*ARM1) + (ARM2*ARM2) - (arm3*arm3))/(2*ARM1*ARM2)));
    ...
    //       return null;
    //     }
    //     jointA = 90 - angleToPoint - Math.toDegrees(Math.acos(((ARM1*ARM1) + (arm3*arm3) - (ARM2*ARM2))/(2*ARM1*arm3)));
    //     jointB = 180 - Math.toDegrees(Math.acos(((ARM1*ARM1) + (ARM2*ARM2) - (arm3*arm3))/(2*ARM1*ARM2)));
